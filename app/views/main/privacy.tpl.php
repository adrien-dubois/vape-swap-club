<div class="container">
    <div class="longtext">
       ...
       <br>
       <br>
Le site web Vape Swap Club est détenu par White Umbrella Dev, qui est un contrôleur de données de vos données personnelles.
</p>
<br>
<p>
...
Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à dubois.adrien.dev@gmail.com.
        </p>
    </div>
</div>